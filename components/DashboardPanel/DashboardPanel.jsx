...
export const DetailButton = styled.button`
  ...
  background-color: ${(props) =>
    props.bgColor ? props.bgColor : COLORS.DETAIL_BTN_PRIMARY};
  border: 1px solid
    ${(props) => (props.bgColor ? props.bgColor : COLORS.DETAIL_BTN_PRIMARY)};
  ...
  const getInitial = () => {
    if (typeof currentApplication === "undefined") {
      ...
      let initialValues = {
        ...
        primaryContactName:
          internships[currentApplication.InternID].PointOfContact,
      ...
      let studentAddress =
        users[currentApplication.StuID].StudentAddress.split(",");
      let initialStuAddr = {
      ...
      let employerAddress =
        internships[currentApplication.InternID].EmployerAddress.split(",");
      let initialEmpAddr = {
      ...
      let initialStartDate = internships[
        currentApplication.InternID
      ].StartDate.substr(
        0,
        internships[currentApplication.InternID].StartDate.indexOf("T")
      );
      let initialEndDate = internships[
        currentApplication.InternID
      ].EndDate.substr(
        0,
        internships[currentApplication.InternID].EndDate.indexOf("T")
      );
      return {
        initialValues,
        initialStartDate,
          ...
          <Row>
            <Col size={1}>
              <div className="dashboard__student__default__image">
                <img
                  src={NWDoubleStackedGreen}
                  alt="Northwest Stacked Logo Green"
                />
              </div>
            </Col>
          </Row>
  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          left: isSideNavOpen ? "20%" : "3.5%",
          width: isSideNavOpen ? `80%` : `96.5%`,
        }}
      >
        <Row maxHeight="65px">
          <MobileNav
          ...
          <Col size={1} maxHeight="65px">
            <div className="dashboard__Header">
              <img
                className="dashboard__profile__pic"
                src={account}
                alt="account.png"
              />
        ...
        {isAppFormVisible && (
          <ApplicationForm getInitial={getInitial} hideAppForm={hideAppForm} />
        )}
        {!isAppFormVisible &&
          !isApplicationTableVisible &&
          role !== "Student" && (
